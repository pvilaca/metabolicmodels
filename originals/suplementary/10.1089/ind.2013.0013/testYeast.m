...
if output
    ...
    media_indexes = all([exchangeRxns,model.lb ~= 0],2);
...
if output == 2
    fprintf('\tlist of auxotrophs viable in minimal medium:\n');
    for k = 1:length(aux_fail)
        fprintf('\t\t%s\n',aux_fail{k});
    end
    
    fprintf('\n\tlist of auxotrophs inviable in maximal medium:\n');
